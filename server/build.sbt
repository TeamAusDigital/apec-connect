...
lazy val api = (project in file("modules/api")).
  ...
  settings(
    ...
    libraryDependencies ++= Seq(
      "io.kanaka" %% "play-monadic-actions" % "1.0.3"
    ),
  ...
  dependsOn(
    ...
    users % Dependencies.CompileAndTest
  )
...
addCommandAlias("run-api-weaved", ";project api; aspectj-runner:run  -Dkamon.modules.kamon-system-metrics.auto-start=false -Dconfig.file=api/conf/application.conf 9000")
